...
import { AlertTriangle, ExternalLink, Info, Search, ShieldAlert, ShieldCheck, X } from "lucide-react"
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
      <div className="lg:col-span-2 space-y-4">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Stay informed about recently identified counterfeit medications</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              <Alert variant="destructive">
                <AlertTriangle className="h-4 w-4" />
                <AlertTitle>Alert: Counterfeit Ciprofloxacin</AlertTitle>
                <AlertDescription>
                  NAFDAC has identified counterfeit Ciprofloxacin 500mg tablets in Lagos and Abuja markets. These
                  products have fake NAFDAC numbers starting with "B7-".
                </AlertDescription>
              ...
              <Alert variant="destructive">
                <AlertTriangle className="h-4 w-4" />
                <AlertTitle>Alert: Fake Antimalarial Medication</AlertTitle>
                <AlertDescription>
                  Counterfeit antimalarial medications have been identified in several markets. These products contain
                  insufficient active ingredients and pose serious health risks.
                </AlertDescription>
                <div className="mt-2 text-xs">
                  <span className="font-medium">Date: </span>
      ...
      <div className="space-y-4">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Direct Reporting</CardTitle>
            <CardDescription>Report suspicious or counterfeit medications directly to NAFDAC</CardDescription>
          </CardHeader>
          <CardContent>
